...
function buyLunches() {
   ...
   while (money > 0) {
       ...
       let numberOfSandwiches = document.getElementById("numSandwiches").value;
        ...
        } else {document.getElementById("receipt").innerHTML += "<p>Today, sandwiches are: $" + priceToday + ". You don't have enough money. Maybe your sister will give you some of her sandwich.</p>";
        money = 0;
    }
