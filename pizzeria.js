...
function placeOrder() {
    ...
    if (deliveryPrice === 0) {
        theOutput +=  "<p>Your total is: $ " + (orderPrice + deliveryPrice) + "<p>Delivery was free!</p>"
    } else {
...
function calculateDelivery(orderPrice, deliveryCity, birthday) {
    let deliveryPrice = 0;
        if ((((deliveryCity === "Anytown") || (deliveryCity === "YourTown") || (deliveryCity === "Sacramento")) && (orderPrice > 10)) || (birthday === "yes"))
        {
            deliveryPrice = 0;
